  ...
  return (
    <div className="bg-custom-gradient dark:bg-dark-gradient">
      <div className="px-5 sm:px-6 md:px-30 pt-6 w-full mx-auto flex justify-between items-center">
        <div className="w-[70%]">
          <span className="text-lg sm:text-sm font-bold md:w-auto pr-6 flex justify-end">
            <p className="text-[#CAF181] dark:text-[#BAB2E7]">TÜRKÇE</p>
            <p className="text-[#D9D9D9] ml-1">'YE GEÇ</p>
          </span>
        </div>
        <div className="w-[30%] flex items-center justify-start pl-6">
          <FontAwesomeIcon
            ...
            size="2x"
            className="text-[#9198fd] dark:text-yellow"
